...
- `/baa game [arena_id] red_alert floor set` — Select and save the floor region.
- `/baa game [arena_id] red_alert setmode <chaos|trail>` — Choose the gameplay mode.

## Technical details
- **Minigame ID:** `red_alert`
